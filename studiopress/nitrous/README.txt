<strong>NITROUS CHILD THEME</strong>
<a href="http://www.studiopress.com/themes/nitrous">http://www.studiopress.com/themes/nitrous</a>

<strong>INSTALL</strong>
1. Upload the Nitrous child theme folder via FTP to your wp-content/themes/ directory. (The Genesis parent theme needs to be in the wp-content/themes/ directory as well.)
2. Go to your WordPress dashboard and select Appearance.
3. Activate the Nitrous theme.
...
By default WordPress will create a default thumbnail image for each image you upload and the size can be specified in your dashboard under Settings > Media. In addition, the Nitrous child theme creates the following thumbnail images you'll see below, which are defined (and can be modified) in the functions.php file. These are the recommended thumbnail sizes that are used on the Nitrous child theme demo site.

featured - 600px by 300px
portfolio - 152px by 100px
