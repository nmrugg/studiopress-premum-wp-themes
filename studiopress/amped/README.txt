Amped Child Theme
http://www.studiopress.com/themes/amped

INSTALL
1. Upload the Amped child theme folder via FTP to your wp-content/themes/ directory. (the Genesis parent theme needs to be in the wp-content/themes/ directory as well)
2. Go to your WordPress dashboard and select Appearance.
3. Activate the Amped theme.
...
FEATURED IMAGES
By default WordPress will create a default thumbnail image for each image you upload and the size can be specified in your dashboard under Settings > Media. In addition, the Amped child theme creates the following thumbnail images you'll see below, which are defined (and can be modified) in the functions.php file. These are the recommended thumbnail sizes that are used on the Amped child theme demo site.

Mini Square - 90px by 90px

GOOGLE ADSENSE
The Amped child theme is coded to display Google AdSense ads (or any other 468x60 ad code) after each single post. To display AdSense, simply open up the adsense.php file and place your code where the note is.
