<strong>SCRIBBLE CHILD THEME</strong>
<a href="http://www.studiopress.com/themes/scribble">http://www.studiopress.com/themes/scribble</a>

<strong>INSTALL</strong>
1. Upload the Scribble child theme folder via FTP to your wp-content/themes/ directory. (The Genesis parent theme needs to be in the wp-content/themes/ directory as well.)
2. Go to your WordPress dashboard and select Appearance.
3. Activate the Scribble theme.
...
Blog - This is the blog section.
Photos - This is the photos section.
Services - This is the services section.
...
By default WordPress will create a default thumbnail image for each image you upload and the size can be specified in your dashboard under Settings > Media. In addition, the Scribble child theme creates the following thumbnail images you'll see below, which are defined (and can be modified) in the functions.php file. These are the recommended thumbnail sizes that are used on the Scribble child theme demo site.

home-blog - 280px by 120px
home-photos - 120px by 120px
