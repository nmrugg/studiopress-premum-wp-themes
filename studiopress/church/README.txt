...
INSTALL
1. Upload the Church child theme folder via FTP to your wp-content/themes/ directory. (the Genesis parent theme needs to be in the wp-content/themes/ directory as well)
2. Go to your WordPress dashboard and select Appearance.
3. Activate the Church theme.
...
FEATURED IMAGES
By default WordPress will create a default thumbnail image for each image you upload and the size can be specified in your dashboard under Settings > Media. In addition, the Church child theme creates the following thumbnail images you'll see below, which are defined (and can be modified) in the functions.php file. These are the recommended thumbnail sizes that are used on the Church child theme demo site.

Mini Square - 70px by 70px
Square - 110px by 110px

THEME COLORS
The Church child theme comes with 4 color styles - style.css, blue.css, brown.css and gray.css. To select the stylesheet which will get loaded, simply go to the Genesis > Theme Settings page in your WordPress dashboard and look for the Church Color Style option box.

PSD FILES
The Church child theme comes with PSD files for images used in the theme. You can download them at http://www.studiopress.com/support/showthread.php?t=31883.
