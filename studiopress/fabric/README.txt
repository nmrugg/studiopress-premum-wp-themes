<strong>FABRIC CHILD THEME</strong>
<a href="http://www.studiopress.com/themes/fabric">http://www.studiopress.com/themes/fabric</a>

<strong>INSTALL</strong>
1. Upload the Fabric child theme folder via FTP to your wp-content/themes/ directory. (The Genesis parent theme needs to be in the wp-content/themes/ directory as well.)
2. Go to your WordPress dashboard and select Appearance.
3. Activate the Fabric theme.
...
By default WordPress will create a default thumbnail image for each image you upload and the size can be specified in your dashboard under Settings > Media. In addition, the Fabric child theme creates the following thumbnail images you'll see below, which are defined (and can be modified) in the functions.php file. These are the recommended thumbnail sizes that are used on the Fabric child theme demo site.

featured - 650px by 280px
sidebar - 70px by 70px

<strong>BACKGROUND</strong>
The background image used in this theme is courtesy of <a href="http://subtlepatterns.com">http://subtlepatterns.com</a>.
