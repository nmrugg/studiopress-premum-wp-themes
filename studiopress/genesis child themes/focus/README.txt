Focus Child Theme
http://www.studiopress.com/themes/focus

INSTALL
1. Upload the Focus child theme folder via FTP to your wp-content/themes/ directory. (The Genesis parent theme needs to be in the wp-content/themes/ directory as well.)
2. Go to your WordPress dashboard and select Appearance.
3. Activate the Focus theme.
...
After Post Left - This is the left section after a post.
After Post Right - This is the right section after a post.
...
FEATURED IMAGES
By default WordPress will create a default thumbnail image for each image you upload and the size can be specified in your dashboard under Settings > Media. In addition, the Focus child theme creates the following thumbnail images you'll see below, which are defined (and can be modified) in the functions.php file. These are the recommended thumbnail sizes that are used on the Focus child theme demo site.
