...
add_meta_box('genesis-theme-settings-slider', __('Church Color Style', 'genesis'), 'ntg_theme_settings_style_box', $_genesis_theme_settings_pagehook, 'column2');
...
?>
    ...
    <p><span class="description">Please select the Church color style from the drop down list and save your settings. Only stylesheets found in the child theme directory will be included in this list.</span></p>
<?php
}
