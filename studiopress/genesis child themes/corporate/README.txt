<strong>Corporate CHILD THEME</strong>
<a href="http://www.studiopress.com/themes/corporate">http://www.studiopress.com/themes/corporate</a>
...
Home Middle #1 - This is the home middle #1 section.
Home Middle #2 - This is the home middle #2 section.
Home Middle #3 - This is the home middle #3 section.
...
By default WordPress will create a default thumbnail image for each image you upload and the size can be specified in your dashboard under Settings > Media. In addition, the Corporate child theme creates the following thumbnail images you'll see below, which are defined (and can be modified) in the functions.php file. These are the recommended thumbnail sizes that are used on the Corporate child theme demo site.

featured - 500px by 240px
home-middle - 275px by 100px
